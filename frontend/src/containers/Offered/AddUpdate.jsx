            ...
            LeadRequest.find(id).then(res => {
                setLead({
                    ...
                    communication_calling_recruiter: res.communication_calling_recruiter
                        ? {
                              key: res.communication_calling_recruiter.id,
                              value: res.communication_calling_recruiter.user_name
                          }
                        : null,
                    ...
                    hr_calling_recruiter: res.hr_calling_recruiter
                        ? { key: res.hr_calling_recruiter.id, value: res.hr_calling_recruiter.user_name }
                        : null,
                    follow_by: res.follow_by ? { key: res.follow_by.id, value: res.follow_by.user_name } : null
                });
    ...
    const onSubmit = () => {
        ...
        if (id) {
            LeadRequest.update(id, {
                ...
                hr_calling_recruiter: lead.hr_calling_recruiter.key,
                follow_by: lead.follow_by.key
            })
                .then(() => history.goBack())
                .catch(err => {
